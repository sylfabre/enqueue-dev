...
class AsyncProcessorTest extends WebTestCase
{
    ...
    public function testShouldRejectIfMessageDoesNotContainEventNameProperty()
    {
        ...
        $this->assertEquals(ProcessorInterface::REJECT, $processor->process($message, new NullContext()));
    }
    ...
    public function testShouldCallRealListener()
    {
        ...
        $this->assertEquals(ProcessorInterface::ACK, $processor->process($message, new NullContext()));
